...
#ifndef USSLIBGUIAPP_FR604X_USS_APP_MASTERINCLUDES_H_
#define USSLIBGUIAPP_FR604X_USS_APP_MASTERINCLUDES_H_

/*! Value used when Gallons per Minute are selected */
#define GPM false
/*! Value used when Liters per Hour are selected */
#define LPH true

/* use with Numbers greater than 1 EXA to avoid floating point truncation */
#define ATTOint                 1 / EXA
#define ATTOfloat               1.0E-18
/* use with Numbers greater than 1 PETA to avoid floating point truncation */
#define FEMTOint                1 / PETA
#define FEMTOfloat              1.0E-15
/* use with Numbers greater than 1 TERA to avoid floating point truncation */
#define PICOint                 1 / TERA
#define PICOfloat               1.0E-12
/* use with Numbers greater than 1 GIGA to avoid floating point truncation */
#define NANOint                 1 / GIGA
#define NANOfloat               1.0E-9
/* use with Numbers greater than 1 MEGA to avoid floating point truncation */
#define MICROint                1 / MEGA
#define MICROfloat              1.0E-6
/* use with Numbers greater than 1 KILO to avoid floating point truncation */
#define MILLIint                1 / KILO
#define MILLIfloat              1.0e-3
/* use with Numbers greater than 1 HECTO to avoid floating point truncation */
#define CENTIint                1 / HECTO
#define CENTIfloat              1.0e-2
/* use with Numbers greater than 1 DECA to avoid floating point truncation */
#define DECIint                 1 / DECA
#define DECIfloat               1.0e-1

// Definitions for unit prefixes
#define HZ                      1
#define DECA                    10
#define HECTO                   100
#define KILO                    1000
...
#define MILLISECONDS_IN_MIN     (float)(SECONDS_IN_MIN)*(KILO)
#define MILLISECONDS_IN_HOUR    (float)(MILLISECONDS_IN_MIN)*(MIN_IN_HOUR)

/*! Maximum expected battery voltage (100%) */
#define BATVOLTAGE_MAX          ((uint32_t) 3300)
/*! Minimum expected battery voltage (0%) */
#define BATVOLTAGE_MIN          ((uint32_t) 2200)

#endif /* USSLIBGUIAPP_FR604X_USS_APP_MASTERINCLUDES_H_ */
